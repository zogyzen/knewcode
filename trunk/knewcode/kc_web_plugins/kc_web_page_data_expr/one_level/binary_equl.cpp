#include "../std.h"
#include "binary_equl.h"

////////////////////////////////////////////////////////////////////////////////
// TBinaryEqul类
KC::one_level::TBinaryEqul::TBinaryEqul(IExprTreeWork& wk, IWebPageData& pd, const TKcEqualToExpr& syn)
    : TBinaryNode(wk, pd, syn)
{
}

// 获取运算符号
string KC::one_level::TBinaryEqul::GetSymbol(void)
{
    return Keychar::one_level::g_SymbolEqualTo;
}

// 计算
boost::any KC::one_level::TBinaryEqul::Calculate(boost::any& lv, boost::any& rv)
{
    // 统一左右值的类型
