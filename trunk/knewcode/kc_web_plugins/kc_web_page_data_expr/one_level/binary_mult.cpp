...
////////////////////////////////////////////////////////////////////////////////
// TBinaryMult类
KC::one_level::TBinaryMult::TBinaryMult(IExprTreeWork& wk, IWebPageData& pd, const TKcStarExpr& syn)
    : TBinaryNode(wk, pd, syn)
{
}

// 获取运算符号
string KC::one_level::TBinaryMult::GetSymbol(void)
{
    return string() + Keychar::one_level::g_SymbolStar;
}

// 计算
boost::any KC::one_level::TBinaryMult::Calculate(boost::any& lv, boost::any& rv)
{
    // 只能是整型或浮点型
