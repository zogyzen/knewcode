#include "../std.h"
#include "binary_less.h"

////////////////////////////////////////////////////////////////////////////////
// TBinaryLess类
KC::one_level::TBinaryLess::TBinaryLess(IExprTreeWork& wk, IWebPageData& pd, const TKcLessExpr& syn)
    : TBinaryNode(wk, pd, syn)
{
}

// 获取运算符号
string KC::one_level::TBinaryLess::GetSymbol(void)
{
    return string() + Keychar::one_level::g_SymbolLess;
}

// 计算
boost::any KC::one_level::TBinaryLess::Calculate(boost::any& lv, boost::any& rv)
{
    // 统一左右值的类型
