...
namespace KC
{
    ...
    // 简单数据类型
    struct IKcWebDataVal : public IKCObject
    {
        // 数据类型
    ...
    // 接口的值
    struct IKcWebInfVal : public IKCObject
    {
        // 接口名称
    ...
    // 管理锁
    struct IKcLockWork : public IKCObject
    {
        // 互斥量
        struct IMutex
        {
            virtual unsigned long long CALL_TYPE MutexID(void) const = 0;
