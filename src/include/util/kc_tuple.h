...
namespace KC
{
    namespace _Private
    {
        ...
        struct TValList
        {
            ...
            template<unsigned i> typename TGetType<i, TValList>::val_type& GetVal(int)
            { return TGetListRef<i, TValList>::GetList(*this).val; }
            template<unsigned i> const typename TGetType<i, TValList>::val_type& GetVal(int) const
        ...
        struct TValList<TVal, TValList<TVoidClass, TList>>
        {
            ...
            template<unsigned i> TVal& GetVal(int) { return val; }
            template<unsigned i> const TVal& GetVal(int) const { return val; }
