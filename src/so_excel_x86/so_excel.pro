...
win32 {
    ...
    CONFIG(debug, debug | release) {
        LIBS += $$PWD/../library/common/xlnt/lib32-msvc-14.0/xlntd.lib
    } else {
        LIBS += $$PWD/../library/common/xlnt/lib32-msvc-14.0/xlnt.lib
    }

    varCopyConfig = \"$$PWD/../library/common/xlnt/lib32-msvc-14.0/*.dll\" \"$$DESTDIR\"
    varCopyConfig ~= s,/,\\,g
